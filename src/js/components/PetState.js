    ...
    return (
      <div>
        <div className="col-12">
          ...
          <div
            className="row justify-content-md-center p-4 font-weight-bold animated fadeIn">{this.props.pet.name} (Счет: {this.props.pet.score})
          </div>
          {/* <div
            className="row justify-content-md-center p-4 font-weight-bold animated fadeIn">{this.props.pet.score}
          </div> */}
        </div>
      </div>
    );
